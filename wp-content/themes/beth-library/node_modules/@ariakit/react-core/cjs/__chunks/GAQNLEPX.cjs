...
var _EWI7RF64cjs = require('./EWI7RF64.cjs');
...
function usePopoverStoreOptions(props) {
  return _EWI7RF64cjs.useDialogStoreOptions.call(void 0, props);
}
function usePopoverStoreProps(store, props) {
  store = _EWI7RF64cjs.useDialogStoreProps.call(void 0, store, props);
  _QW7NAUIXcjs.useStoreProps.call(void 0, store, props, "placement");
  return store;
}
function usePopoverStore(props = {}) {
  const options = usePopoverStoreOptions(props);
  const store = _QW7NAUIXcjs.useStore.call(void 0, 
    () => Core.createPopoverStore(_72I2GWXFcjs.__spreadValues.call(void 0, _72I2GWXFcjs.__spreadValues.call(void 0, {}, props), options))
  );
