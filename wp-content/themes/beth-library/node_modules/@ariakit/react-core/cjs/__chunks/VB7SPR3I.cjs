...
var _5SFIKBWFcjs = require('./5SFIKBWF.cjs');
...
function findById(items, id, baseId) {
  return items.findIndex((item, index) => {
    var _a;
    const itemId = _5SFIKBWFcjs.getCollectionRendererItemId.call(void 0, item, index, baseId);
    if (itemId === id)
      return true;
    const object = getItemObject(item);
...
function useCompositeRenderer(_a) {
  ...
  store = store || context;
  const orientation = (_a2 = _QW7NAUIXcjs.useStoreState.call(void 0, 
    store,
    (state) => (orientationProp != null ? orientationProp : state.orientation === "both") ? "vertical" : state.orientation
  )) != null ? _a2 : orientationProp;
  const items = _QW7NAUIXcjs.useStoreState.call(void 0, store, (state) => {
    var _a3;
  ...
  const activeId = _QW7NAUIXcjs.useStoreState.call(void 0, store, "activeId");
  ...
  return _5SFIKBWFcjs.useCollectionRenderer.call(void 0, _72I2GWXFcjs.__spreadProps.call(void 0, _72I2GWXFcjs.__spreadValues.call(void 0, {
    id,
    store,
    orientation,
    persistentIndices
