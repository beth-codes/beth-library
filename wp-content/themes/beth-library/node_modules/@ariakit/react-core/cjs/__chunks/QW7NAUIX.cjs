...
function useStoreState(store, keyOrSelector = _misc.identity) {
  ...
  return _indexjs.useSyncExternalStore.call(void 0, storeSubscribe, getSnapshot, getSnapshot);
}
...
function useStore(createStore) {
  ...
  return React.useMemo(
    () => _72I2GWXFcjs.__spreadProps.call(void 0, _72I2GWXFcjs.__spreadValues.call(void 0, {}, store), { useState }),
    [store, useState]
  );
}
