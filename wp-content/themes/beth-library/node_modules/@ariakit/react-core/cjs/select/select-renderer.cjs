...
var _VB7SPR3Icjs = require('../__chunks/VB7SPR3I.cjs');



var _5SFIKBWFcjs = require('../__chunks/5SFIKBWF.cjs');
...
function useSelectRenderer(_a) {
  ...
  var _a2, _b2;
  const context = _react.useContext.call(void 0, _RCGSDYWJcjs.SelectContext);
  store = store || context;
  const items = (_a2 = _QW7NAUIXcjs.useStoreState.call(void 0, 
    store,
    (state) => state.mounted ? itemsProp != null ? itemsProp : state.items : 0
  )) != null ? _a2 : itemsProp;
  const value = (_b2 = _QW7NAUIXcjs.useStoreState.call(void 0, store, (state) => valueProp != null ? valueProp : state.value)) != null ? _b2 : valueProp;
  ...
  return _VB7SPR3Icjs.useCompositeRenderer.call(void 0, _72I2GWXFcjs.__spreadValues.call(void 0, {
    store,
    items,
    persistentIndices
  }, props));
}
var SelectRenderer = _CWY2PHPRcjs.forwardRef.call(void 0, function SelectRenderer2(props) {
...
exports.SelectRenderer = SelectRenderer; exports.getSelectRendererItem = _5SFIKBWFcjs.getCollectionRendererItem; exports.getSelectRendererItemId = _5SFIKBWFcjs.getCollectionRendererItemId;
