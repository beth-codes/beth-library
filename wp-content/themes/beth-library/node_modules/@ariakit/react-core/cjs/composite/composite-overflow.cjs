...
var _FVVV75ZKcjs = require('../__chunks/FVVV75ZK.cjs');
require('../__chunks/OHBR6IPU.cjs');
require('../__chunks/4PH5LF7R.cjs');
...
var useCompositeOverflow = _CWY2PHPRcjs.createHook.call(void 0, 
  (_a) => {
    ...
    props = _FVVV75ZKcjs.usePopover.call(void 0, _72I2GWXFcjs.__spreadValues.call(void 0, {
      store,
      backdropProps,
      wrapperProps,
      portal
