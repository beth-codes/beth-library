...
const ROOT_BLOCK_SUPPORTS = ['background', 'backgroundColor', 'color', 'linkColor', 'captionColor', 'buttonColor', 'headingColor', 'fontFamily', 'fontSize', 'fontStyle', 'fontWeight', 'lineHeight', 'textDecoration', 'textTransform', 'padding'];
...
const PRESET_METADATA = [{
  ...
  valueFunc: (preset, settings) => (0, _typographyUtils.getTypographyFontSizeValue)(preset, (0, _typographyUtils.getFluidTypographyOptionsFromSettings)(settings)),
  valueKey: 'size',
...
function areGlobalStyleConfigsEqual(original, variation) {
  ...
  return (0, _es.default)(original?.styles, variation?.styles) && (0, _es.default)(original?.settings, variation?.settings) && (0, _es.default)(original?.behaviors, variation?.behaviors);
}
