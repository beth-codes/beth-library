...
const withDuotoneControls = createHigherOrderComponent(BlockEdit => props => {
  ...
  // performance.
  return createElement(Fragment, null, hasDuotoneSupport && blockEditingMode === 'default' && createElement(DuotonePanel, {
    ...props
...
const withDuotoneStyles = createHigherOrderComponent(BlockListBlock => props => {
  ...
  const className = shouldRender ? classnames(props?.className, filterClass) : props?.className;
