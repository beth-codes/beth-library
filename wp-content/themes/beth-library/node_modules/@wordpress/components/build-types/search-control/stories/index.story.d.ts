...
export default meta;
export declare const Default: import("@storybook/types").AnnotatedStoryFn<import("@storybook/react/dist/types-0a347bb9").R, Pick<import("../../base-control/types").BaseControlProps, "help" | "label" | "__nextHasNoMarginBottom"> & {
 ...
 * rather than just clearing the input value.
 */
export declare const WithOnClose: import("@storybook/types").AnnotatedStoryFn<import("@storybook/react/dist/types-0a347bb9").R, Pick<import("../../base-control/types").BaseControlProps, "help" | "label" | "__nextHasNoMarginBottom"> & {
    hideLabelFromVision?: boolean | undefined;
    onChange: (value: string) => void;
    onClose?: (() => void) | undefined;
    placeholder?: string | undefined;
