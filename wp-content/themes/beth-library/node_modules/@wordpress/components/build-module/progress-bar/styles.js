...
export const Track = _styled("div", process.env.NODE_ENV === "production" ? {
  target: "e15u147w2"
} : {
  target: "e15u147w2",
  label: "Track"
...
export const Indicator = _styled("div", process.env.NODE_ENV === "production" ? {
  ...
  target: "e15u147w1",
  label: "Indicator"
})("display:inline-block;position:absolute;top:0;height:100%;border-radius:", CONFIG.radiusBlockUi, ";background-color:", COLORS.theme.accent, ";", ({
  isIndeterminate,
  value
