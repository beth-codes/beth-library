...
const writingMode = {
  name: 'writingMode',
  generate: (style, options) => {
    return (0, _utils.generateRule)(style, options, ['typography', 'writingMode'], 'writingMode');
  }
};
var _default = [fontFamily, fontSize, fontStyle, fontWeight, letterSpacing, lineHeight, textColumns, textDecoration, textTransform, writingMode];
