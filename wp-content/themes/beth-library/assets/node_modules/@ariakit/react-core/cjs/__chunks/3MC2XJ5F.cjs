...
var _JQNHOFVLcjs = require('./JQNHOFVL.cjs');


var _ZWMVFMQYcjs = require('./ZWMVFMQY.cjs');


var _O22LNQHScjs = require('./O22LNQHS.cjs');


var _F4UT5TWUcjs = require('./F4UT5TWU.cjs');


var _XE2DJMCIcjs = require('./XE2DJMCI.cjs');


var _HUVFPCMZcjs = require('./HUVFPCMZ.cjs');
...
var useDialog = _CWY2PHPRcjs.createHook.call(void 0, 
  (_a) => {
    ...
    _HUVFPCMZcjs.useHideOnInteractOutside.call(void 0, store, hideOnInteractOutside);
    const { wrapElement, nestedDialogs } = _XE2DJMCIcjs.useNestedDialogs.call(void 0, store);
    ...
    _5WLTMVVQcjs.useSafeLayoutEffect.call(void 0, () => {
      ...
      if (!shouldDisableAccessibilityTree) {
        return _FSADYSOPcjs.markTreeOutside.call(void 0, id, disclosureElement, ...allElements);
      }
      if (modal) {
        return _misc.chain.call(void 0, 
          _FSADYSOPcjs.markTreeOutside.call(void 0, id, ...allElements),
          _ZWMVFMQYcjs.disableTreeOutside.call(void 0, ...allElements)
        );
      }
      return _misc.chain.call(void 0, 
        _FSADYSOPcjs.markTreeOutside.call(void 0, id, disclosureElement, ...allElements),
        _O22LNQHScjs.disableAccessibilityTreeOutside.call(void 0, ...allElements)
      );
    }, [
      domReady,
      id,
    ...
    _react.useEffect.call(void 0, () => {
      ...
      const onKeyDown = (event) => {
        ...
        if (!dialog)
          return;
        if (_FSADYSOPcjs.isElementMarked.call(void 0, dialog))
          return;
