...
var _44MSVBJLcjs = require('../__chunks/44MSVBJL.cjs');
...
function useFormStoreProps(store, props) {
  ...
  _KLWT4P56cjs.useStoreProps.call(void 0, store, props, "errors", "setErrors");
  _KLWT4P56cjs.useStoreProps.call(void 0, store, props, "touched", "setTouched");
  ...
  const useValidate = _react.useCallback.call(void 0, 
    (callback) => {
      callback = _5WLTMVVQcjs.useEvent.call(void 0, callback);
...
function useFormStore(props = {}) {
  ...
  const store = _KLWT4P56cjs.useStore.call(void 0, () => Core.createFormStore(_72I2GWXFcjs.__spreadValues.call(void 0, _72I2GWXFcjs.__spreadValues.call(void 0, {}, props), options)));
...
exports.useFormStore = useFormStore; exports.useFormStoreOptions = useFormStoreOptions; exports.useFormStoreProps = useFormStoreProps;
