...
var _63OBHNVTcjs = require('../__chunks/63OBHNVT.cjs');



var _IMHF4TCRcjs = require('../__chunks/IMHF4TCR.cjs');
...
function useSelectRenderer(_a) {
  ...
  store = store || context;
  const items = (_a2 = _KLWT4P56cjs.useStoreState.call(void 0, 
    store,
    (state) => state.mounted ? itemsProp != null ? itemsProp : state.items : 0
  )) != null ? _a2 : itemsProp;
  const value = (_b2 = _KLWT4P56cjs.useStoreState.call(void 0, store, (state) => valueProp != null ? valueProp : state.value)) != null ? _b2 : valueProp;
  ...
  return _63OBHNVTcjs.useCompositeRenderer.call(void 0, _72I2GWXFcjs.__spreadValues.call(void 0, {
    store,
    items,
    persistentIndices
  }, props));
...
exports.SelectRenderer = SelectRenderer; exports.getSelectRendererItem = _IMHF4TCRcjs.getCollectionRendererItem; exports.getSelectRendererItemId = _IMHF4TCRcjs.getCollectionRendererItemId;
