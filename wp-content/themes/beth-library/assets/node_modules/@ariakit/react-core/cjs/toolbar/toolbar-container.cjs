...
var _OYXMXGQJcjs = require('../__chunks/OYXMXGQJ.cjs');


var _IQIITEH3cjs = require('../__chunks/IQIITEH3.cjs');
...
var useToolbarContainer = _CWY2PHPRcjs.createHook.call(void 0, 
  (_a) => {
    var _b = _a, { store } = _b, props = _72I2GWXFcjs.__objRest.call(void 0, _b, ["store"]);
    props = _OYXMXGQJcjs.useCompositeContainer.call(void 0, _72I2GWXFcjs.__spreadValues.call(void 0, { store }, props));
    props = _IQIITEH3cjs.useToolbarItem.call(void 0, _72I2GWXFcjs.__spreadValues.call(void 0, { store }, props));
    return props;
  }
);
var ToolbarContainer = _CWY2PHPRcjs.createMemoComponent.call(void 0, 
  (props) => {
