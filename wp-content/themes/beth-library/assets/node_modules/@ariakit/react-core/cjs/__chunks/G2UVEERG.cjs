...
var _SIVNE3PRcjs = require('./SIVNE3PR.cjs');
...
var _KLWT4P56cjs = require('./KLWT4P56.cjs');
...
var useCompositeItem = _CWY2PHPRcjs.createHook.call(void 0, 
  (_a) => {
    ...
    const rowId = _KLWT4P56cjs.useStoreState.call(void 0, store, (state) => {
      if (rowIdProp)
        return rowIdProp;
    ...
    const baseElement = _KLWT4P56cjs.useStoreState.call(void 0, 
      store,
    ...
    const isActiveItem = _KLWT4P56cjs.useStoreState.call(void 0, store, (state) => state.activeId === id);
    const virtualFocus = _KLWT4P56cjs.useStoreState.call(void 0, store, "virtualFocus");
    ...
    const ariaSetSize = _KLWT4P56cjs.useStoreState.call(void 0, store, (state) => {
    ...
    const ariaPosInSet = _KLWT4P56cjs.useStoreState.call(void 0, store, (state) => {
    ...
    const isTabbable = (_a2 = _KLWT4P56cjs.useStoreState.call(void 0, store, (state) => {
    ...
    props = _SIVNE3PRcjs.useCollectionItem.call(void 0, _72I2GWXFcjs.__spreadProps.call(void 0, _72I2GWXFcjs.__spreadValues.call(void 0, {
      store
    }, props), {
      getItem,
