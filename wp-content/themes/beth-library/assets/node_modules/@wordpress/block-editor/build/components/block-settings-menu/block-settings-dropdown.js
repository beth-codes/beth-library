...
function CopyMenuItem({
  ...
  const copyMenuItemBlocksLabel = blocks.length > 1 ? (0, _i18n.__)('Copy blocks') : (0, _i18n.__)('Copy');
...
function BlockSettingsDropdown({
  ...
  }), !parentBlockIsSelected && !!firstParentClientId && (0, _element.createElement)(_components.MenuItem, {
  ...
  }, (0, _i18n.__)('Add after')))), canCopyStyles && (0, _element.createElement)(_components.MenuGroup, null, (0, _element.createElement)(CopyMenuItem, {
    blocks: blocks,
    onCopy: onCopy,
