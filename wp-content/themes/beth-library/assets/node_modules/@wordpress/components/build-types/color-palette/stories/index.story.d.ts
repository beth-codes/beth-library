...
export default meta;
export declare const Default: import("@storybook/types").AnnotatedStoryFn<import("@storybook/react/dist/types-0a347bb9").R, Pick<{
...
export declare const MultipleOrigins: import("@storybook/types").AnnotatedStoryFn<import("@storybook/react/dist/types-0a347bb9").R, Pick<{
    className?: string | undefined;
    clearColor: () => void;
    onChange: (newColor?: string | undefined, index?: number | undefined) => void;
    value?: string | undefined;
