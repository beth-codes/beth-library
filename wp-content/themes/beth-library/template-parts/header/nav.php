...
$menu_class = \Beth_Theme\Inc\Menu::get_instance();
$header_menu_id =$menu_class-> get_menu_id('beth-header-menu');
...
<!-- <header class="header"> -->
                        ...
                        foreach ($header_menus as $menu_item){
                           if (!$menu_item->menu_item_parent) {
                              ...
                              if (! $has_children) {
                                 ?>
                                 <li>
                                    <a class="navbar-list" href="<?php echo esc_url($menu_item->url); ?>">
      ...
      <!-- <div class="header-desc">
         ...
         <h1>
            Stay once, carry memeries forever.
         </h1>
      ...
      // wp_nav_menu([
      //    'theme_location' => 'beth-header-menu',
      //    'container-class' => 'my-extra-menu-class'
      // ]);
      ?>
   <!-- </header> -->